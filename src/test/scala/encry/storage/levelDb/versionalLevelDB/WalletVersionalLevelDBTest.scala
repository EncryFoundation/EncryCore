...
//
//
//  property("Applying 5000 blocks. Wallet balance should be correct") {
//
//    val blocksToWallet: Seq[Block] = (0 until 5000).foldLeft(generateDummyHistory(settings), Seq.empty[Block]) {
...
//
//      //check correct balance
//      blocksToWallet.last.id shouldEqual walletVersionalDB.currentVersion
//
...
//
//      //check correct head of tree
//      blocksToWallet.dropRight(10).last.id shouldEqual walletVersionalDB.currentVersion
//  }
//
...
//
//      //check correct head of tree
//      blocksToWallet.dropRight(rollbackLength).last.id shouldEqual walletVersionalDB.currentVersion
//  }
//
