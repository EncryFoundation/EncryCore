...
class DeliveryManagerPriorityTests extends WordSpecLike
  ...
  def initialiseState: (TestActorRef[DeliveryManager], ConnectedPeer, ConnectedPeer, ConnectedPeer,
    ...
    val (deliveryManager, _) = initialiseDeliveryManager(isBlockChainSynced = true, isMining = true, mainTestSettings)
    val (_: InetSocketAddress, cp1: ConnectedPeer) = createPeer(9001, "172.16.13.10", mainTestSettings)
    val (_: InetSocketAddress, cp2: ConnectedPeer) = createPeer(9002, "172.16.13.11", mainTestSettings)
    val (_: InetSocketAddress, cp3: ConnectedPeer) = createPeer(9003, "172.16.13.12", mainTestSettings)
    val (_: InetSocketAddress, cp4: ConnectedPeer) = createPeer(9004, "172.16.13.13", mainTestSettings)
    val (_: InetSocketAddress, cp5: ConnectedPeer) = createPeer(9005, "172.16.13.14", mainTestSettings)
    val (_: InetSocketAddress, cp6: ConnectedPeer) = createPeer(9006, "172.16.13.15", mainTestSettings)
    val (_: InetSocketAddress, cp7: ConnectedPeer) = createPeer(9007, "172.16.13.16", mainTestSettings)
    val (_: InetSocketAddress, cp8: ConnectedPeer) = createPeer(9008, "172.16.13.17", mainTestSettings)
    val (_: InetSocketAddress, cp9: ConnectedPeer) = createPeer(9009, "172.16.13.18", mainTestSettings)
    val blocks: List[Block] = generateBlocks(10, generateDummyHistory(mainTestSettings))._2
