...
import encry.network.NodeViewSynchronizer.ReceivableMessages.{ChangedHistory, RequestFromLocal}
...
import org.encryfoundation.common.network.BasicMessagesRepo.{Handshake, InvNetworkMessage, RequestModifiersNetworkMessage, SyncInfoNetworkMessage}
import org.encryfoundation.common.network.SyncInfo
import org.scalatest.mockito.MockitoSugar
import org.scalatest.{BeforeAndAfterAll, Matchers, OneInstancePerTest, WordSpecLike}

class RequestModifiersSpec extends TestKit(ActorSystem("RequestModifiersSpec"))
  with WordSpecLike
