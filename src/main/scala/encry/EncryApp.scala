...
object EncryApp extends App {
  ...
  println(new ByteArrayWrapper(EncryPaymentBox.idFromBox(nb1.proposition,nb1.nonce)).data)
  println(new AddressProposition(Address @@ recepientProp.address).address)
  ...
  val testHeader = EncryBlockHeader(99.toByte, ModifierId @@ Longs.toByteArray(999L), Digest32 @@ Array[Byte](32), 9999L, 0, targetedDiff = 2)
