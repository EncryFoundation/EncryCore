...
trait HistoryHeadersDefaultProcessorComponent extends HistoryHeadersProcessorComponent {
  ...
  class DefaultHeadersProcessor extends HeadersProcessor {

    override def processHeader(h: Header): ProgressInfo = getHeaderInfoUpdate(h) match {
    ...
    private def toDownload(header: Header): Option[(ModifierTypeId, ModifierId)] =
      ...
      // Headers chain is synced after this header. Start downloading full blocks
        ...
        isHeadersChainSyncedVariable = true
