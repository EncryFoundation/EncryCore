...
final case class EncryHistoryNew(storage: HistoryStorage)
  extends HistoryModifiersValidations with HistoryModifiersProcessor {
  ...
  def reportModifierIsValid(modifier: PersistentModifier) = {
...
object EncryHistoryNew extends StrictLogging {
