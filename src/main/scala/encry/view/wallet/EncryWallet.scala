...
import encry.utils.{BalanceCalculator, BoxFilter, EncryLogging}
...
case class EncryWallet(walletStore: Store, keyManager: KeyManager)
  extends Vault[EncryProposition, EncryBaseTransaction, EncryPersistentModifier, EncryWallet] with EncryLogging {
