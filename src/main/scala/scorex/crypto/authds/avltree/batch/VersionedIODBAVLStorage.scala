...
class VersionedIODBAVLStorage[D <: Digest](store: Store, nodeParameters: NodeParameters)
  ...
  private val DigestLength: Int = 33
  private val InitialVersion: ADDigest = ADDigest @@ Array.fill(DigestLength)(11: Byte)
  private val fixedSizeValueMode: Boolean = nodeParameters.valueSize.isDefined
